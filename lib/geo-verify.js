...
// Modèle unique : le backend ne fait tourner qu'un moteur gratuit
// (vérifié le 2026-09-05 — les autres noms répondaient via le même moteur).
const VERIFY_MODELS = ["gpt-5.6-luna"];
